...
export const Route = createFileRoute('/dashboard/')({ component: DashboardList })
...
function DashboardList() {
  ...
  const jsonl = unparse(data.reduce((acc, info) => {
  ...
  return (
    <div className="p-4 space-y-2">
      ...
      <div className="flex justify-end">
        <Button asChild><a href={`data:text/plain;charset=utf-8,${encodeURIComponent(jsonl)}`} download='tasks.jsonl'>Save</a></Button>
      </div>
    </div>
  )
}
